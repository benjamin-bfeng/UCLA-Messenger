  ...
  renderEditView = () => {
    return (
      <div>
        ...
        />
        <div>
          <button className={'button button4'} onClick={this.changeEditMode}>
            CANCEL
          </button>
          <button
  ...
  renderDefaultView = () => {
    return (
      <div className={'profile-div1'}>
        {this.state.value}
        <button className={'button button2'} onClick={this.changeEditMode}>
          EDIT
        </button>
      </div>
    );
          ...
          <div className={classes.flex}>
            <div className={classes.photoAndChats}>
              <div className={classes.title}>
                <h1>
                  <EditableText value={name} onChange={handleName} />
                </h1>
              </div>
              <img className={classes.img} src={imageUrl} alt={'defProf'} />
              <label htmlFor="avatar">
                <h2 className={classes.upload}>Choose a profile picture:</h2>
              </label>
              <input
                type="file"
                id="avatar"
              ...
              <Card className={classes.cardRoot}>
                <CardContent>
                  <Typography variant="h5" component="h2">
                    <EditableText value={role} onChange={handleRole} />
                  </Typography>
                  <Typography
                    ...
                    gutterBottom
                  >
                    <EditableText value={desc} onChange={handleDesc} />
                  </Typography>
                </CardContent>
              </Card>
            </div>
